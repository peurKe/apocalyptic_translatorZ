...
class Translator:
            ...
            try:
                ...
                # DeepL translator
                    ...
                    try:
                        ...
                        self.logs.log(f" [WARN] DeepL translator failed. Check your DeepL API key and your DeepL API usage. Google translator will be used as failback. {e}", c='FAIL', force=True)
    ...
    def deeplcli_translate(self, text, translator=None, translator_args=None):
        """
        Translator using DeepLCLI.
        """
        translator = DeepLCLI(self.lang_source.get('deeplcli'), self.lang_target.get('deeplcli'))
        translated = translator.translate(text.replace('"','').replace('\n',' '))
        # translated = translator.translate(text)
        
        sleep(0.5)
        
        # Return translated text by DeepLCLI
        return translated
