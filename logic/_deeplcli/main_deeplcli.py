...
def main():
    ...
    try:
        ...
        argparser.add_argument("-t", "--translators", type=str, default='deepl,google', choices=['deeplcli,google', 'deepl,google', 'google,deepl', 'deeplcli', 'deepl', 'google'], help="List of translators in order of preference to be used for translating. (default value: 'deepl,google')")
